...
<div class="twelve columns veinte-botton">
	<h2><?php _e( 'Actividad de la Comunidad', 'buddypress' ); ?></h2>
</div>
...
<div class="twelve columns" id="blanco">
	<div id="comunidad" class="content">
		...
		<div class="eight columns activity" role="main"><!-- activity in the home page -->
				
			<div class="item-list-tabs no-ajax" id="subnav" role="navigation">
				<ul>
					<li class="feed">
					<a href="<?php bp_sitewide_activity_feed_link(); ?>" title="<?php _e( 'RSS Feed', 'buddypress' ); ?>"><?php _e( 'RSS', 'buddypress' ); ?></a>
					</li>
