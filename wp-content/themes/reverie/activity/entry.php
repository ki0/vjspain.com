...
<li class="<?php bp_activity_css_class(); ?>" id="activity-<?php bp_activity_id(); ?>">
	...
	<div class="activity-content">
		...
		<?php if ( is_user_logged_in() ) : ?>
			...
			<div class="nine columns activity-meta">
				...
				<?php if ( bp_activity_can_favorite() ) : ?>
					...
					<?php if ( !bp_get_activity_is_favorite() ) : ?>
						<!-- Favorite button -->
						<a href="<?php bp_activity_favorite_link(); ?>" class="button fav bp-secondary-action" title="<?php esc_attr_e( 'Mark as Favorite', 'buddypress' ); ?>"><?php _e( 'Favorite', 'buddypress' ); ?><i class="foundicon-heart"></i></a>
						<!-- Favorite button -->
					<?php else : ?>
						<!-- Remove favorite button -->
						<a href="<?php bp_activity_unfavorite_link(); ?>" class="button unfav bp-secondary-action" title="<?php esc_attr_e( 'Remove Favorite', 'buddypress' ); ?>"><?php _e( 'Remove Favorite', 'buddypress' ); ?><i class="foundicon-remove"></i></a>
						<!-- Remove favorite button -->
					<?php endif; ?>
