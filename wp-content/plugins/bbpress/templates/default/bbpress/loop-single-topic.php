...
<ul id="topic-<?php bbp_topic_id(); ?>" <?php bbp_topic_class(); ?>>
	...
	<div class="bbp-topic-title twelve columns">
	...
	<?php do_action( 'bbp_theme_before_topic_meta' ); ?>
		...
		<div class="bbp-topic-meta">
			...
			<div class="bbp-topic-started-by">
				<?php printf( __( '%1$s', 'bbpress' ), bbp_get_topic_author_link( array( 'size' => '84' ) ) ); ?>
			</div>
		...
		<h3><a class="bbp-topic-permalink" href="<?php bbp_topic_permalink(); ?>" title="<?php bbp_topic_title(); ?>"><?php bbp_topic_title(); ?></a>
		</h3>
		...
		<div class="seven columns">
			<?php bbp_show_lead_topic() ? bbp_topic_reply_count() : bbp_topic_post_count(); ?> Respuestas, m&aacute;s reciente
