...
*/
	...
	//stolen from phpBB includes/function.php
	class PhpbbAuth
	{
		/**
		...
		*/
		public function phpbb_check_hash($password, $hash)
		{
			...
			if (strlen($hash) == 34)
			{
				return (PhpbbAuth::_hash_crypt_private($password, $hash, $itoa64) === $hash) ? true : false;
			}
		...
		*/
		public function _hash_gensalt_private($input, &$itoa64, $iteration_count_log2 = 6)
		{
			...
			$output .= PhpbbAuth::_hash_encode64($input, 6, $itoa64);
		...
		*/
		public function _hash_crypt_private($password, $setting, &$itoa64)
		{
			...
			*/
			...
			$output .= PhpbbAuth::_hash_encode64($hash, 16, $itoa64);
